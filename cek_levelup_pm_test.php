...
<form action="cek_levelup_pm_test.php" method="post" >
...
$xvalr1 = $_POST["valr1"];
 ...
 echo "<script>window.location='cek_levelup_pm_test.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
  ...
  echo "<script>window.location='cek_levelup_pm_test.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_levelup_pm_test.php" method="post" enctype="multipart/form-data">
