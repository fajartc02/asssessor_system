...
$queryku = mysqli_query($con, "select t_finding_pm.fphoto, t_finding_pm.fnote, t_finding_pm.fdate_modified as tgl, t_schedule_pm.* from t_finding_pm join t_schedule_pm on t_finding_pm.fid_schedule =  t_schedule_pm.fid where t_finding_pm.fid_schedule in ($idschedule,$idplan,$idcheck) and t_finding_pm.fid_score = '$idscore' order by t_finding_pm.fdate_modified desc");
