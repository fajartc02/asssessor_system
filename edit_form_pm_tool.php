...
$searchku = "";
$searchku = "select * from t_form_pm_tool where fid = '$fidku'";
...
<div class="container-fluid p-1">
  <center><legend>Edit Form PM Tool</legend><hr /></center>
...
<td valign="top">:</td>
<td>
  <textarea class="form-control" name="fitem3"><?php echo $fitem3; ?></textarea>
</td>
</tr>
...
<tr>
<td valign="top">Evidance</td>
<td valign="top">:</td>
<td>
  <textarea class="form-control" name="fevi"><?php echo $fevi; ?></textarea>
</td>
</tr>
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_pm_test set fitem1 = '$fitem1', fitem2 = '$fitem2', fitem3 = '$fitem3', fsilver = '$fsilver', fgold = '$fgold', fdesc = '$fdesc', fevi = '$fevi', fskor = '$fskor', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=16'</script>";    
