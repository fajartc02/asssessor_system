...
<form action="cek_levelup_pm.php" method="post" >
	...
	while($des2=mysqli_fetch_array($des))
{
 ...
 echo "<script>window.location='cek_levelup_pm.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_levelup_pm.php" method="post" enctype="multipart/form-data">
