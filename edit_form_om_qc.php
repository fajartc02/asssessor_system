...
$searchku = "";
$searchku = "select * from t_form_om_qc where fid = '$fidku'";
...
<div class="container-fluid p-1">
  <center><legend>Edit Form OM Quality Control</legend><hr /></center>
...
<td valign="top">:</td>
<td>
  <textarea class="form-control" name="fevaluasi"><?php echo $fevaluasi; ?></textarea>
</td>
</tr>
...
<option value="">-pilih-</option>
<?php
$queryku = mysqli_query($con, 'select distinct flevel from t_form_om_qc');
while($queryku2=mysqli_fetch_array($queryku))
{
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_om_qc set fitem = '$fitem', fevaluasi = '$fevaluasi', fscore = '$fscore', fdesc = '$fdesc', flevel = '$flevel', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=5'</script>";    
