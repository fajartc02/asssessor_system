...
<form action="cek_board_om.php" method="post" >
	...
	while($des2=mysqli_fetch_array($des))
{
 ...
 echo "<script>window.location='cek_board_om.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
 ...
 echo "<script>window.location='cek_board_om.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_board_om.php" method="post" enctype="multipart/form-data">
