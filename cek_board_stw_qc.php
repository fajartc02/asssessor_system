...
$ss = mysqli_query($con, "select count(fid) as jml from t_form_stw_qc where flevel = 'gold' order by fid asc");
...
<th width="40%"><center>Standard evaluasi</center></th>
<th width="5%"><center>Hasil</center></th>
<th width="5%"><center>Score</center></th>
<th width="20%"><center>Penjelasan</center></th>
...
$test = mysqli_query($con, "select * from t_form_stw_qc where flevel = 'gold' order by fid asc");
...
if (isset($_POST['update']))
{
  ...
  $fidx = $_POST["fidx"];
  	...
  	$blth_now = date("Y-m");
   	...
   	$sub = mysqli_query($con, "select count(fid) as jml from t_form_stw_qc where flevel = 'gold' order by fid asc");
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
	...
	<?php $sub = mysqli_query($con, "select count(fid) as jml from t_form_stw_qc where flevel = 'gold' order by fid asc");
   while($sub2=mysqli_fetch_array($sub))
   {
	$jml_form_om = $sub2['jml']; 
   }
...
<?php include('includes/footer.php'); ?>    
	...
	<?php $subx = mysqli_query($con, "select count(fid) as jml from t_form_stw_qc where flevel = 'gold' order by fid asc");
