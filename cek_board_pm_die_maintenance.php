...
$ss = mysqli_query($con, "select count(fid) as jml from t_form_pm_die_maintenance order by fid asc");
...
<form action="cek_board_pm_die_maintenance.php" method="post" >
...
$test = mysqli_query($con, "select * from t_form_pm_die_maintenance order by fid asc");
...
$sub = mysqli_query($con, "select count(fid) as jml from t_form_pm_die_maintenance order by fid asc");
...
while($queryku2=mysqli_fetch_array($queryku))
{
	...
	$des = mysqli_query($con, "select * from t_form_pm_die_maintenance where fid = '$fid_score'");
	while($des2=mysqli_fetch_array($des))
{
 ...
 echo "<script>window.location='cek_board_pm_die_maintenance.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
 ...
 $sub = mysqli_query($con, "select count(fid) as jml from t_form_pm_die_maintenance order by fid asc");
  ...
  echo "<script>window.location='cek_board_pm_die_maintenance.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_board_pm_die_maintenance.php" method="post" enctype="multipart/form-data">
	  
	  	  	  	  	   <!-- data score -->
	
	<?php $sub = mysqli_query($con, "select count(fid) as jml from t_form_pm_die_maintenance order by fid asc");
   while($sub2=mysqli_fetch_array($sub))
   {
	$jml_form_pm = $sub2['jml']; 
   }
...
<?php include('includes/footer.php'); ?>    
    ...
    type: 'POST',
    data: dataString,
    url: 'cek_pm_die_maintenance.php',       
	...
	<?php $subx = mysqli_query($con, "select count(fid) as jml from t_form_pm_die_maintenance order by fid asc");
