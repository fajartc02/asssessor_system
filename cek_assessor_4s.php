...
<form action="cek_assessor_4s.php" method="post" >
<input type="hidden" id="fid" name="fidx" value="<?php echo $fid; ?>" />
...
<br>
<!--
<center><h5>Ada temuan ?</h5></center>
<br>
-->
</div>
	...
	while($des2=mysqli_fetch_array($des))
{
	...
	echo "<script>window.location='cek_assessor_4s.php?fid=$fidx'</script>";
...
if (isset($_POST['submit_temuan']))
{
  ...
  */
  ...
  //
	 ...
	 echo "<script>window.location='cek_assessor_4s.php?fid=$fid_schedule'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_assessor_4s.php" method="post" enctype="multipart/form-data">
      <!-- Modal body -->
