...
<td>
   <select name="valr<?php echo $no_jml; ?>"  class="<?php echo str_replace(array(' ', '&', '(', ')','/'), array('', '','','',''), $fitem); ?>" onchange="<?php echo str_replace(array(' ', '&', '(', ')'), array('', '','',''), $fitem); ?>();ubahscore()" id="valr<?php echo $no_jml; ?>" id="valr<?php echo $no_jml; ?>" value="<?php echo $valr[$no]; ?>" style="width: 45px;">
