...
$searchku = "";
$searchku = "select * from t_form_pm_test where fid = '$fidku'";
...
<div class="container-fluid p-1">
  <center><legend>Edit Form PM Test</legend><hr /></center>
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_pm_test set fitem1 = '$fitem1', fitem2 = '$fitem2', fsilver = '$fsilver', fgold = '$fgold', fdesc = '$fdesc', fskor = '$fskor', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=15'</script>";    
