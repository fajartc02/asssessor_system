...
$searchku = "";
$searchku = "select * from t_form_stw where fid = '$fidku'";
...
<div class="container-fluid p-1">
  <center><legend>Edit Form STW</legend><hr /></center>
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_stw set fitem = '$fitem', fsilver = '$fsilver', fgold = '$fgold', fdesc = '$fdesc', fscore = '$fscore', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=6'</script>";    
