...
$queryku = mysqli_query($con, "select t_finding_4s.fnote,  t_finding_4s.fphoto, t_finding_4s.fdate_modified as tgl, t_schedule_4s.* from t_finding_4s join t_schedule_4s on t_finding_4s.fid_schedule =  t_schedule_4s.fid where t_finding_4s.fid_schedule in ($idschedule,$idplan,$idcheck) and t_finding_4s.fid_score = '$idscore' order by t_finding_4s.fdate_modified desc");
