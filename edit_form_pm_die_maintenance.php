...
$searchku = "";
$searchku = "select * from t_form_pm_die_maintenance where fid = '$fidku'";
...
<div class="container-fluid p-1">
  <center><legend>Edit Form PM Die Maintenance</legend><hr /></center>
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_pm_die_maintenance set fitem = '$fitem', fsilver = '$fsilver', fgold = '$fgold', fdesc = '$fdesc', fskor = '$fskor', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=11'</script>";    
