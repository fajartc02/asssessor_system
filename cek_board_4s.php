...
$ss = mysqli_query($con, "select count(fid) as jml from t_form_4s order by fid asc");
...
<form action="cek_board_4s.php" method="post" >
...
<input type="hidden" name="fid" value="<?php echo $farray_valuesmm; ?>">
<input type="hidden" name="fid" value="<?php echo $farray_valuenye; ?>">
...
$farray_value = $_POST["farray_value"];
 $fid_pd = $_POST["fid_pd"];
  ...
  echo "<script>window.location='cek_board_4s.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
  ...
  echo "<script>window.location='cek_board_4s.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <div class="modal-header">
        <h4 class="modal-title">Isi Temuan 4S</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <form action="cek_board_4s.php" method="post" enctype="multipart/form-data">
