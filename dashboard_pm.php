	...
	<div class="card shadow mb-4">
		...
		<script>
          function filtering() {
            ...
            window.location = "dashboard_pm.php?q=" + selectid;
          }
        </script>
		</div>
		<div class="card-body">
            ...
            $xfilter = $_GET["q"];
            if ($xfilter != "") {
              $cond = " and t_schedule_pm.fline = '$xfilter'";
            } else {
              $cond = "";
            }
...
//}
			...
			while ($queryku2 = mysqli_fetch_array($queryku)) {
				...
				$query_sh =  mysqli_query($con, "SELECT * from t_schedule_pm where fjobas = 'Section Head' and fworsite = '$fworsite' and substring(fdate, 1, 7) = '$thmo'");
				...
				*/
				$query_cross =  mysqli_query($con, "SELECT * from t_schedule_pm where fjobas = 'Manager' and fworsite = '$fworsite' and substring(fdate, 1, 7) = '$thmo'");
				...
				$query_cross =  mysqli_query($con, "SELECT * from t_schedule_pm where fjobas = 'Manager Cross' and fworsite = '$fworsite' and substring(fdate, 1, 7) = '$thmo'");
				while ($query_cross2 = mysqli_fetch_array($query_cross)) {
				...
				$query_div =  mysqli_query($con, "SELECT * from t_schedule_pm where fjobas = 'Division' and fworsite = '$fworsite' and substring(fdate, 1, 7) = '$thmo'");
