...
<form action="cek_board_pm_assy.php" method="post" >
	...
	while($des2=mysqli_fetch_array($des))
{
 ...
 echo "<script>window.location='cek_board_pm_assy.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
  ...
  echo "<script>window.location='cek_board_pm_assy.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
