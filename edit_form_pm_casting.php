...
$searchku = "";
$searchku = "select * from t_form_pm_casting where fid = '$fidku'";
...
<div class="container-fluid p-1">
  <center><legend>Edit Form PM Casting</legend><hr /></center>
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_pm_casting set fitem = '$fitem', fsilver = '$fsilver', fgold = '$fgold', fdesc = '$fdesc', fskor = '$fskor', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=10'</script>";    
