...
<form action="cek_board_pm_log.php" method="post" >
	...
	while($des2=mysqli_fetch_array($des))
{
 ...
 echo "<script>window.location='cek_board_pm_log.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
 ...
 $score = number_format($_POST["idtotalscore"], 2, '.', '');
  ...
  echo "<script>window.location='cek_board_pm_log.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_board_pm_log.php" method="post" enctype="multipart/form-data">
