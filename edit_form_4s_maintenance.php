...
$searchku = "";
$searchku = "select * from t_form_4s_maintenance where fid = '$fidku'";
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_4s_maintenance set fjudul = '$fjudul', fpoint = '$fpoint', fscore = '$fscore', fverybad = '$fverybad', fbad = '$fbad', fnormal = '$fnormal', fgood = '$fgood',fverygood = '$fverygood', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=2'</script>";    
