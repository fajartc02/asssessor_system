...
<form action="cek_levelup_om_qc.php" method="post" >
...
<tr>
  ...
  <td></td>
  <td> <a href="#myModal" onclick="getId(document.getElementById('fid_score').value='1','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='2','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='3','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='4','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='5','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
 ...
 <select name="valsb6" id="vals6" style="width: 45px;">
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='6','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
 ...
 <select name="valsb7" id="vals7" style="width: 45px;">
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='7','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
 ...
 <select name="valsb8" id="vals8" style="width: 45px;">
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='8','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='9','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
   <p class="text-center"><br/>
...
<tr>
 ...
 <select name="valsb10" id="vals10" style="width: 45px;">
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='10','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td></td>  
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='11','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td><br><br><br><br>A. Ada map & list semua equipment yg dimiliki (boleh juga drawing penempatan asset fix)</td>  
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='12','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td><br><br><br>A. List equipment yg perlu maintenance (boleh juga beda kamar)<br>B. Melaksanakan sesuai planing (tidak ada keterlambatan equipment laporan ke government office)<br><br> ※Jika government office pada waktu audit teridentifikasi masalah besar berarti tidak lulus</td>  
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='13','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
 ...
 <select name="valrs14" id="valrs14" style="width: 45px;">
  ...
  <td><br><br>A. Ada planing pendidikan & training<br><br><br>B.1 Pendidikan & training berjalan sesuai planing
   ...
   <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='14','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
  Total : <?php echo $jml14;?> Temuan</p>
    <br><br>
   <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='15','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
    <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='16','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='17','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal" onclick="getId(document.getElementById('fid_score').value='18','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
 ...
 <select name="valss19" id="vals19" style="width: 45px;">
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='19','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
  Total : <?php echo $jml19;?> Temuan</p>
    <br/><br/> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='20','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='21','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='22','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td></td> 
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='23','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td><br><br><br><br>A. Ada map & list semua equipment yg dimiliki (boleh juga drawing penempatan asset fix)</td>  
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='24','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td><br><br><br>A. List equipment yg perlu maintenance (boleh juga beda kamar)<br>B. Melaksanakan sesuai planing (tidak ada keterlambatan equipment laporan ke government office)<br><br> ※Jika government office pada waktu audit teridentifikasi masalah besar berarti tidak lulus</td>  
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='25','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
 ...
 <select name="valrg27" id="valrg27" style="width: 45px;">
  ...
  <td><br><br>A. Ada planing pendidikan & training<br><br><br>B.1 Pendidikan & training berjalan sesuai planing
   ...
   <td><br/><br/><a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='26','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
  Total : <?php echo $jml26;?> Temuan</p>
    <br/><br/><a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='27','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td><br><br>A. Ada rekord, dan dilakukan share<br><br> ※Contoh share : rekord/catatan yg sudah disampaikan informasi dari member di tulis ke ledger & map </td>  
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='28','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <br><br><br><a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='29','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>

     <p class="text-center"><br/>
  Total : <?php echo $jml29;?> Temuan</p>
    <br/><br/> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='30','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td><br><br>A. Melakukan aktivitas dari pengembangan step bagian yg lemah & meningkatkanya<br>B. Melakukan aktivitas bagian yg menjadi perlu untuk saat ini & masa depan</td>  
   <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='31','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td><br><br>A. Planing, target, item pelaknsanaan menjadi dimengerti<br><br>B.Prosentase progres masing-masing level memuaskan<br>（Jika belum tercapai, harus ada alasan yg tepat)<br><br><br>C. Manager, CL melakukan follow cek (ada komentar tulisan tangan)
   ...
   <td> <br><br><a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='32','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
  Total : <?php echo $jml32;?> Temuan</p>
    <br><br><br><a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='33','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='34','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
...
<tr>
  ...
  <td>
    ...
    <td> <a href="#myModal"  onclick="getId(document.getElementById('fid_score').value='35','<?php echo $fidx; ?>','<?php echo $fid_pd; ?>');" data-toggle="modal" data-target="#myModal" class="btn btn-info" >Isi Temuan</a>
     <p class="text-center"><br/>
	...
	while($des2=mysqli_fetch_array($des))
{
 ...
 echo "<script>window.location='cek_levelup_om_qc.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
  ...
  echo "<script>window.location='cek_levelup_om_qc.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_levelup_om_qc.php" method="post" enctype="multipart/form-data">
