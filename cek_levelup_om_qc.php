...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
	...
	<?php $sub = mysqli_query($con, "select count(fid) as jml from t_form_om_qc where flevel = 'gold' order by fid asc");
   while($sub2=mysqli_fetch_array($sub))
   {
	$jml_form_om = $sub2['jml']; 
   }
...
<?php include('includes/footer.php'); ?>    
  ...
  <script>
	...
	<?php $subx = mysqli_query($con, "select count(fid) as jml from t_form_om_qc where flevel = 'gold' order by fid asc");
