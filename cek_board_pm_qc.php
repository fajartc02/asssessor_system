...
$queryku = mysqli_query($con, "select farray_result, farray_score from t_schedule_pm where fline = '$fline' and fworsite = '$fworsite' and finfo = 'Plan and Do'");
...
$queryconfirm = mysqli_query($con, "select * from t_schedule_pm where fid = '$fid'");
...
$queryf = mysqli_query($con, "select t_finding_pm.fnote, t_finding_pm.fdate_modified as tgl, t_schedule_pm.* from t_finding_pm join t_schedule_stw on t_finding_pm.fid_schedule =  t_schedule_pm.fid where t_finding_pm.fid_schedule in ($fid_pd,$fidx) order by t_finding_pm.fdate_modified desc");
while($queryf2=mysqli_fetch_array($queryf))
{
  $fnotex = $queryf2['fnote']; 
...
if (isset($_POST['update']))
{
  ...
  $farray_score = $xvals1.";".$xvals2.";".$xvals3.";".$xvals4.";".$xvals5.";".$xvals6.";".$xvals7.";".$xvals8.";".$xvals9.";".$xvals10.";".$xvals11.";".$xvals12.";".$xvals13.";".$xvals14.";".$xvals15.";".$xvals16.";".$xvals17.";".$xvals18.";".$xvals19.";".$xvals20.";".$xvals21.";".$xvals22.";".$xvals23.";".$xvals24.";".$xvals25.";".$xvals26.";".$xvals27.";".$xvals28;
      ...
      $fscorex = $xvals10 + $xvals11 + $xvals12 + $xvals13 + $xvals14 + $xvals15 + $xvals16 + $xvals17 + $xvals18 + $xvals19 + $xvals20 + $xvals21 + $xvals22 + $xvals23 + $xvals24 + $xvals25 + $xvals26 + $xvals27 + $xvals28;

    $scorex = round(($fscorex / 57) * 100);
   ...
   $no = 1;
    ...
    $emailBody .="<td  width=\"5%\">No</td><td width=\"15%\">Item</td><td width=\"15%\"></td><td width=\"15%\">Evaluasi</td><td width=\"15%\">Deskripsi</td><td width=\"15%\">Note</td><td width=\"20%\">Temuan</td><td width=\"20%\">Tanggal</td>";
    $emailBody .="</tr>";
...
while($queryku2=mysqli_fetch_array($queryku))
{
	...
	$des = mysqli_query($con, "select * from t_form_pm_qc where fid = '$fid_score'");
	while($des2=mysqli_fetch_array($des))
{
	...
	$emailBody .="<tr>";
    $emailBody .="<td>$no</td><td>$fitem1</td><td>$fitem2</td><td>$feva</td><td>$fdesc</td><td>$xml->body</td><td><img style='width:100px;' src='".LOC_IMAGE."images/temuanPM/".$fphoto."' /></td><td>$fdate_modified</td>";
    $emailBody .="</tr>";
  ...
  mysqli_query($con, "update t_schedule_pm set farray_result = '$farray_result', farray_score = '$farray_score', fscore = '$scorex' where fid = '$fid_pd'");
 ...
 echo "<script>window.location='cek_board_pm_qc.php?fid=$fidx&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
if (isset($_POST['submit_temuan']))
{
 ...
 $fid_pd = $_POST["fid_pd"];
  ...
  mysqli_query($con, "update t_schedule_pm set farray_result = '$farray_result', farray_score = '$farray_score', fscore = '$scorex' where fid = '$fidx'");
  
  
  //AKhir Nilai
  
  echo "<script>window.location='cek_board_pm_qc.php?fid=$fid_schedule&&fline=$flinex&&fworsite=$fworsitex'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_board_pm_qc.php" method="post" enctype="multipart/form-data">
