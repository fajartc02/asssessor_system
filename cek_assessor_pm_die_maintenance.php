	...
	while($des2=mysqli_fetch_array($des))
{
  ...
  echo "<script>window.location='cek_assessor_pm_die_maintenance.php?fid=$fidx'</script>";
...
if (isset($_POST['submit_temuan']))
{
  ...
  echo "<script>window.location='cek_assessor_pm_die_maintenance.php?fid=$fid_schedule'</script>";
...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
      ...
      <form action="cek_assessor_pm_die_maintenance.php" method="post" enctype="multipart/form-data">
...
<?php include('includes/footer.php'); ?>    
    ...
    type: 'POST',
    data: dataString,
    url: 'cek_pm_ok_die_maintenance.php',       
