...
$searchku = "";
$searchku = "select * from t_form_pm_qc where fid = '$fidku'";
...
<div class="container-fluid p-1">
  <center><legend>Edit Form PM Quality Control</legend><hr /></center>
...
<td valign="top">:</td>
<td>
  <textarea class="form-control" name="feva"><?php echo $feva; ?></textarea>
</td>
</tr>
...
<option value="">-pilih-</option>
<?php
$queryku = mysqli_query($con, 'select distinct flevel from t_form_pm_qc');
while($queryku2=mysqli_fetch_array($queryku))
{
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "update t_form_pm_qc set fitem1 = '$fitem1', fitem2 = '$fitem2', feva = '$feva', fdesc = '$fdesc', fskor = '$fskor', flevel = '$flevel', fdate_modified = now() where fid = '$fid'");        

  echo "<script>window.location='edit_form_3pillars.php?id=14'</script>";    
