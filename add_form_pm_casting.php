...
<div class="container-fluid p-1">
  <center><legend>Add Form PM Casting</legend><hr /></center>
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "insert into t_form_pm_casting (fitem, fsilver, fgold, fdesc, fskor, fdate_modified) values ('$fitem', '$fsilver', '$fgold', '$fdesc', '$fskor', now())");
