                ...
                <div class="p-5">
                  ...
                  <form class="user" action="login_check.php" method="post">
                    <div class="form-group">
                      <input type="text"  name="fnoreg" class="form-control form-control-user"  placeholder="Enter No.Reg ...">
                    </div>
                    <div class="form-group">
                      <input type="password" name="fpassword" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                    </div>
                    <div class="form-group">
