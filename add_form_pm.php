...
<div class="container-fluid p-1">
  <center><legend>Add Form PM</legend><hr /></center>
...
if (isset($_POST['submit']))
{
    ...
    mysqli_query($con, "insert into t_form_pm (fitem1, fitem2, fsilver, fgold, fdesc, fskor, fdate_modified) values ('$fitem1', '$fitem2', '$fsilver', '$fgold', '$fdesc', '$fskor', now())");
